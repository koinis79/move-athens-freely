      ...
      <div className="container flex h-[var(--header-height)] items-center justify-between">
        <Link to="/" aria-label="Moveability — Home" className="flex-shrink-0 mr-3">
          <img
            ...
            alt="Moveability"
            className="h-11 lg:h-[52px] w-auto dark:brightness-0 dark:invert dark:sepia dark:saturate-[5] dark:hue-rotate-[5deg] dark:drop-shadow-[0_0_8px_rgba(255,255,255,0.2)]"
          />
        </Link>
