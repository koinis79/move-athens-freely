...
const Footer = () => {
  return (
    <footer role="contentinfo" style={{ backgroundColor: 'hsl(var(--footer-bg))', color: 'hsl(var(--footer-fg))' }}>
      <div className="container py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-sm font-semibold uppercase tracking-wider text-background/50 mb-4">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-background/70">
              <li>
                <a href="mailto:info@moveability.gr" className="hover:text-background transition-colors">
                  info@moveability.gr
                </a>
              </li>
              <li>
                <a href="tel:+30210XXXXXXX" className="hover:text-background transition-colors">
                  +30 210 XXX XXXX
                </a>
              </li>
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-background transition-colors inline-flex items-center gap-1.5"
                >
