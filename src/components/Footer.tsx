...
const footerFg20 = "hsl(var(--footer-fg) / 0.2)";
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                style={{ backgroundColor: footerFg10 }}
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Wheelchairs", "Power Wheelchairs", "Mobility Scooters", "Rollators"].map((item) => (
                <li key={item}>
                  <Link
                    to="/equipment"
                    className="text-sm hover:opacity-100 transition-colors"
                    style={{ color: footerFg70 }}
                  >
                    {item}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm" style={{ color: footerFg70 }}>
              <li>
                <a href="mailto:info@moveability.gr" className="hover:opacity-100 transition-colors">
                  info@moveability.gr
                </a>
              </li>
              <li>
                <a href="tel:+302109511750" className="hover:opacity-100 transition-colors">
                  +30 210 95 11 750
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs" style={{ borderTop: `1px solid ${footerFg10}`, color: footerFg50 }}>
          ...
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="hover:opacity-100 transition-colors">
              Privacy Policy
            </Link>
            <Link to="/terms-of-service" className="hover:opacity-100 transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
