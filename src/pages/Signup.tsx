...
const getStrength = (pw: string) => {
  ...
  if (score === 2) return { label: "Fair", pct: 50, color: "bg-secondary" };
  if (score === 3) return { label: "Good", pct: 75, color: "bg-accent" };
    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-[420px] rounded-2xl border bg-card p-8 shadow-sm space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Book equipment faster and track your rentals</p>
        </div>
        ...
        <form onSubmit={handleEmail} className="space-y-4">
          ...
          <div>
            ...
            <Input id="phone" type="tel" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+30 69x xxx xxxx" />
          </div>
          <div>
